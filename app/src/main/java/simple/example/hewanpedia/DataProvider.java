...
public class DataProvider {
    ...
    private static List<Tikus> initDataTikus(Context ctx) {
        ...
        tikuses.add(new Tikus("tikus got", "got",
                "kuping atau telinga yang tipis namun lebar, badannya jauh lebih lentur dibandingkan dengan jenis tikus lainnya yang biasa berkeliaran di sekitar rumah, memiliki hidung yang mancung dan ukuran tubuh yang memanjang dari mulut hingga ujung buntut", R.drawable.tikusgot));
        tikuses.add(new Tikus("tikus atap", "atap",
                "bentuk telinga yang jauh lebih kecil namun berbulu, tubuh tikus atap memiliki ukuran yang lebih kecil namun dipenuhi sedikit banyak bulu dibandingkan jenis tikus lainnya yang ada di lingkungan, bentuk hidung tikus atap lebih tumpul dan pendek dibandingkan dengan tikus got", R.drawable.tikusatap));
        tikuses.add(new Tikus("tikus rumah", "rumah",
                "ukuran tubuhnya tidak terlalu besar dan juga tidak terlalu kecil, biasanya tikus rumah memiliki ukuran tubuh berkisar dari 2 cm hingga 10 cm, ukuran dan panjang buntutnya lebih panjang dari tikus got", R.drawable.tikusrumahan));
        return tikuses;
    }
